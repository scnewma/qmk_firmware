...
[_JNUM] = LAYOUT_ortho_4x12(
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_ENT,  KC_0, KC_PDOT, KC_NO, KC_NO,   KC_NO
),

// Jamie Symbols
[_JSYM] = LAYOUT_ortho_4x12(
    KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO,   KC_GRV,  KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO,   KC_BSLS, KC_DLR,  KC_PERC, KC_CIRC, KC_NO,   KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_LBRC, KC_RBRC, KC_EXLM, KC_AT,   KC_HASH, KC_NO,   KC_NO,
    KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
),
